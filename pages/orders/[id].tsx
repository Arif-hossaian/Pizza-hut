...
import { orderInfoData, orderTableTitle } from '../../utils/mocData';
    ...
    <>
      ...
      <div className="container mx-auto p-6 mt-20 font-mono grid md:grid-cols-3 gap-4  justify-center items-center">
                ...
                {orderInfoData.map((info, i) => (
                  <>
                    ...
                    >
                      ...
                      <td className="px-6 py-4">{info.customerName}</td>
                      <td className="px-6 py-4">{info.address}</td>
                      <td className="px-6 py-4">{info.total}</td>
                    </tr>
                  </>
                ))}
              </tbody>
                  ...
                  <div className="w-1/4">
                    <div className="relative mb-2">
                      <div
                        ...
                        style={{
                          width: 'calc(calc(100% - 2.5rem - 1rem))',
                          top: '50%',
        ...
        <div className="p-10 mx-auto bg-red-200 shadow overflow-hidden sm:rounded-lg dark:bg-red-300 dark:text-black">
          ...
          <Link href="/sucessMsg" passHref>
            <Button className="justify-center items-center text-center">
              Paid
            </Button>
          </Link>
        </div>
